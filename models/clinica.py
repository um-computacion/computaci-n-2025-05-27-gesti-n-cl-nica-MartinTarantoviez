...
from models.exception import (PacienteExistenteError, PacienteNoExisteError,MedicoExistenteError, MedicoNoExisteError,TurnoDuplicadoError, MedicoNoAtiendeEspecialidadError,MedicoNoTrabajaEseDiaError,EspecialidadVaciaError)
class Clinica:
    def __init__(self):
    ...
    def obtener_dia_semana_en_espanol(self, fecha_hora: datetime) -> str:
        return fecha_hora.strftime("%A").capitalize() 
