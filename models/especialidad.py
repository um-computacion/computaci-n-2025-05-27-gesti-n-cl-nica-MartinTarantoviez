...
from models.exception import (TipoEspecialidadInvalidoError,DiasAtencionInvalidosError)

class Especialidad:
    
    DIAS_VALIDOS_PARA_ATENCION = ["lunes", "martes", "miércoles", "jueves", "viernes", "sábado", "domingo"]
